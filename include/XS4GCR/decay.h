...
#ifndef INCLUDE_XS4GCR_DECAY_H_
#define INCLUDE_XS4GCR_DECAY_H_
...
class Decay_Chart {
   public:
    enum decay_mode { STABLE, EC, BETA_MINUS, BETA_PLUS, ECMIXED_PLUS, ECMIXED_MINUS };
